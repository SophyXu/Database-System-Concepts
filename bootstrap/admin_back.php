...
<html lang="en">
  <head>
   ...
   <script language="javascript">
    function chk(form){
      if (form.id.value==""){
        alert("请输入借书证卡号");form.id.focus();return false;
      }
    }
    </script>
  </head>
  ...
  <div class="container-fluid">
      ...
      <div class="span4">
        ...
        <br>
         <form class="form-horizontal" action="write_back.php" method="POST">
      ...
      <div class="span4">
        <dl class="dl-horizontal">
        <br>
          <form class="form-horizontal" action="display_borrow.php" method="GET">
            <div class="control-group">
              <h4>查询所有已借书籍：</h4>
              <div class="controls">
                <input type="text" name="id"placeholder="请输入借书证号">
