...
<html lang="en">
  ...
  <form name="form1" action="display_borrow.php"> 
    <div class="container">
      <div class="masthead">
        <h3 class="muted">品味生后 · 关注邓准图书馆</h3>
        <div class="navbar">
    ...
    <div class="container-fluid">
      <div class="row-fluid">
        ...
        <li class="active"><a href="admin_back.php">还书</a></li>
      ...
      <div class="span10">
        <dl class="dl-horizontal">
          <?php
            include("conn/conn.php");
            $card_id = $_GET['id'];
            $sql = mysql_query("select book.book_id, category, book_name, publisher, writer, price, pub_time, warehouse.total_num , warehouse.left_num from record, book, warehouse where record.card_id='$card_id' and book.book_id=record.book_id and book.book_id=warehouse.book_id limit 50");
            $row = mysql_fetch_array($sql);
            if($row==false)
              echo "<script language='javascript'>alert('该借书证卡号不存在！');</script>";
            else 
          ?>
          ...
          <a href="admin_back.php"><button class="btn btn-large" type="button">返回</button></a>
        </dl>
      </div>
    </div>
  </div>
