    ...
    <div class="container-fluid">
      ...
      <div class="span4">
        ...
        <ul class="breadcrumb">
          ...
          <li class="active">添加借书证</li>
        </ul>
       <form class="form-horizontal" action="card_add.php" method="POST">
            <p>卡号：</p>
            <div class="controls">
              <input name="id" type="text" class="logininput">
            </div>
            <br>
            <p>姓名：</p>
            <div class="controls">
              <input name="name" type="text" class="logininput">
            </div>
            <br>
            <p>单位：</p>
            <div class="controls">
              <input name="company" type="text" class="logininput">
            </div>
            <br>
            <p>类别： </p>
            <div class="controls">
              <input name="category" type="text" class="logininput">
            </div>
            <br>
            <div class="control-group">
              <div class="controls">
              <input name="submit" type="submit" class="btn btn-primary" value="添加" onClick="return check(form)">
