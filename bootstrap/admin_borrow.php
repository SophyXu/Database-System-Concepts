  ...
  <body>
    ...
    <div class="container-fluid">
      ...
      <div class="span4">
        ...
        <br>
         <form class="form-horizontal" action="write_borrow.php" method="POST">
            ...
            <br>
              <div class="controls">
                <input type="text" name="idd"placeholder="请输入书号">
              </div>
            </div>
            <div class="controls">
              <input name="submit" type="submit" class="btn btn-primary" value="确认" onClick="return lend(form)">
            </div>
          </form>
        </dl>
      </div>
      <div class="span4">
        <dl class="dl-horizontal">
        <br>
          <form class="form-horizontal" action="display_back.php" method="GET">
            <div class="control-group">
              <h4>查询所有已借书籍：</h4>
              <div class="controls">
                <input type="text" name="id"placeholder="请输入借书证号">
            ...
            <div class="controls">
              <input name="submit" type="submit" class="btn btn-primary" value="确认" onClick="return lend_chk(form)">
            </div>
          </form>
        </dl>
      </div>
